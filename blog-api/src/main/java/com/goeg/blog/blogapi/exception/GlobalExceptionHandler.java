...
import com.goeg.blog.blogapi.dto.ErrorDetails;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(BlogApiJsonException.class)
	public ResponseEntity<ErrorDetails> handlerApiBlogJsonException(ResourceNotFoundException exception, WebRequest request){
		ErrorDetails error = new ErrorDetails(new Date(), exception.getMessage(), request.getDescription(false));
